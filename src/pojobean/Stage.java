...
public class Stage {
	...
	private Set<StageHours> listStageHours;
	...
	public Stage(SchoolStudent student, String entName, String entSpvName, String entSpvMail,
	...
	/***********************getters****************************************/
	public SchoolStudent getStudent() { return this.student; }
	...
	public Set<StageHours> getListStageHours() { return this.listStageHours; }
	
	/***********************setters****************************************/
	public void setStudent(SchoolStudent value) { this.student = value; }
	...
	/***********************méthodes publiques*****************************/
	public boolean addStageHour(StageHours sh) {
	...
	public void removeStageHour (StageHours sh) {
		if (this.listStageHours.contains(sh))
	...
	public Stage studentTraining(SchoolStudent ss) throws Exception{
